...
Constraints TarifHub must satisfy as given — they bound every decision in chapters 04–09. The first is the architectural constraint everything else serves:
...
| 10 | **Conventional Commits, squash-merge green PRs only** | Linear, machine-readable history; nothing lands red — CI gates (ruff, pytest, gitleaks, Trivy) are the merge condition. |
