...
This site is the project-thesis deliverable for the FFHS CAS *AI-Assisted Software Engineering* (FS26), together with the source code in the public Git repository at [github.com/erhanuenlue/tarifhub](https://github.com/erhanuenlue/tarifhub). The whole site is also available as a single [Full document (PDF)](print_page/) export.
