...
- **Ex-factory price as the canonical value**: rejected. Retail is the public-facing reimbursed price consumers expect, while ex-factory is retained in metadata for transparency, not as the served value.
