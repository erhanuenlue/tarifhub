# ADR-018: Orchestrator model lifecycle (Fable 5 early blocks, then Opus 4.8, with Fable access scheduled to end 22 Jun 2026)
...
**Consequences.** One pin point, a one-command switch, zero behavioural change elsewhere in
