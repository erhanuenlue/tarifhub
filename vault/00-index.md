...
> Rebuilt by the `brain_sync` hook at every session end (2026-06-12 08:09). Do not edit by hand — edit the sources.
...
- Last docs change: 2026-06-12 · fix(search): e5 query-prefix on serving search + cross-lingual ranking eval (#7)
