...
> Rebuilt by the `brain_sync` hook at every session end (2026-06-12 12:34). Do not edit by hand — edit the sources.
...
- Last docs change: 2026-06-12 · feat(ingestion): hash-integrity pair — Decimal scale contract + AI fill-reuse (#8)
