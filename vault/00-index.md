...
> Rebuilt by the `brain_sync` hook at every session end (2026-06-12 17:35). Do not edit by hand — edit the sources.
...
- Last docs change: 2026-06-12 · docs+ci: §1 Problemstellung & Vision (criterion 3 → 3/3) + cas-anchors ratchet job (#15)
