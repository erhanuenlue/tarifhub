...
- Every new route gets: input model, output model, an OpenAPI summary line, and a test. Read paths must not import anything from `ingestion`'s AI modules — keep the import graph clean for the AST boundary test.
