...
Context: [Option A — this is the existing tarifhub repo with the new orchestrator control files applied / Option B — greenfield from the architecture doc]. We are in **Block 0** of the CAS plan (CAS Dossier §6): foundation honest, due Sunday 14 June.
